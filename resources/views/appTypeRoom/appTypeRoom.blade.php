...
@section('content')
<div class="card">
  <div class="card-header">Добавить новый тип номера</div>

  <div class="card-body">
    <form class="reserv_form" action="/apptyperoom" method="POST">
        @csrf

      <div class="form-group row">
        <label for="full_name" class="col-lg-3 col-md-3 col-form-label text-md-right">Название типа</label>
        <div class="col-lg-6 col-md-8">
          <input type="text" required id="type_room" class="form-control" name="type_room" maxlength="30">
        </div>
      </div>
